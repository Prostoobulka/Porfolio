(() => {
    ...
    function initSliders() {
        if (document.querySelector(".popular-carousel__swiper")) new swiper_core_Swiper(".popular-carousel__swiper", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            speed: 800,
            navigation: {
                prevEl: ".popular-control-carousel__prev",
                nextEl: ".popular-control-carousel__next"
            },
            breakpoints: {
                0: {
                    slidesPerView: 1.3,
        ...
        if (document.querySelector(".testimonials__slider")) new swiper_core_Swiper(".testimonials__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".control-testimonials__prev",
                nextEl: ".control-testimonials__next"
            },
            breakpoints: {
                0: {
                    slidesPerView: 1.3,
...
***************************************************************************** */
    ...
    if (document.querySelector("#map")) {
        (g => {
            ...
            key: "AIzaSyDzRxEFgDEXLggGtN8N8h3hdWRKyKx_Fjc",
            v: "weekly"
        });
        let map;
        async function initMap() {
            ...
            map = new Map(document.getElementById("map"), {
                center: {
                    lat: 50.44975206554358,
                    lng: 30.523247079934446
                },
                zoom: 13,
                mapId: "c081edb65b962e0c"
            });
